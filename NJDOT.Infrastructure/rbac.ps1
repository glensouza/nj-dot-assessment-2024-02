...
.EXAMPLE
.\rbac.ps1 -tenantId '00000000-0000-0000-0000-000000000000' -subscriptionId '00000000-0000-0000-0000-000000000000' -applicationName 'njdot' -repoName 'nj-dot-assessment-2024-02'
#>
